public class VehicleRunner {
	public static void main(String[] args) {
		...
		Taxi tx1 = new Taxi("8KM23Z", 9.25, 3, true, 5);
		tx1.printTaxi();
		tx1.printCar();
		System.out.println(tx1.calculateTollPrice());
		System.out.println(tx1 instanceof Taxi);
		System.out.println(tx1 instanceof Car);
		System.out.println(tx1 instanceof Vehicle);
